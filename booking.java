...
public class booking extends javax.swing.JFrame {
    ...
    public void connect() {
        try {
            Class.forName("jittu");
            try {
                c = DriverManager.getConnection("jittu", "root", "system");
    ...
    private void initComponents() {
        ...
        t3.setFont(new java.awt.Font("Times New Roman", 1, 24));

        b3.setFont(new java.awt.Font("Times New Roman", 1, 24));
        b3.setText("BOOK");
        ...
        b2.setFont(new java.awt.Font("Times New Roman", 1, 24));
        b2.setText("RESET");
        ...
        b1.setFont(new java.awt.Font("Times New Roman", 1, 24));
        b1.setText("SUBMIT");
        ...
        c1.setFont(new java.awt.Font("Times New Roman", 1, 24));
        c1.setModel(new javax.swing.DefaultComboBoxModel(
        new String[] { "Pune", "Mumbai", "Kolkata", "Delhi", "Bangalore", "Ahmedabad" }));

        c2.setFont(new java.awt.Font("Times New Roman", 1, 24));
        c2.setModel(new javax.swing.DefaultComboBoxModel(
        new String[] { "Mumbai", "Pune", "Kolkata", "Delhi", "Bangalore", "Ahmedabad" }));

        c3.setFont(new java.awt.Font("Times New Roman", 1, 24));
        c3.setModel(new javax.swing.DefaultComboBoxModel(
        new String[] { "6:00 am", "8:00 am", "12:00 pm", "2:00 pm", "5:00 pm", "9:00 pm" }));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout
                                                ...
                                                .addComponent(t3, javax.swing.GroupLayout.PREFERRED_SIZE, 96,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(280, 280, 280)))
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(jLabel5)
                                                        .addComponent(c3, javax.swing.GroupLayout.PREFERRED_SIZE, 32,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(jLabel7)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void b3ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            String s3 = (String) t1.getText();
            String s4 = (String) c3.getSelectedItem();
            String s5 = (String) t3.getText();

            p = c.prepareStatement(
                    "insert into book(User_Name,S_Source,destination,No_of_passenger,Time,,Paid_amt)values(?,?,?,?,?,?)");
            p.setString(1, s);
            p.setString(2, s1);
            p.setString(3, s2);
            p.setString(4, s3);
